...
<div style="color:red;">5.修改最近一次提交的commit</div>  
...
- [添加SSH密钥](https://www.bilibili.com/video/av56582999/?p=28)（如果连不上把unknown_hosts中的文件删掉）</li>
- git clone 仓库地址 本机地址 <span style="color:purple;">把远程仓库clone到本机的指定路径</span>  
- **origin**:远程主机名，即与本地仓库关联的远程仓库
...
- git fetch origin &nbsp;&nbsp;<span style="color:purple;">取回远程主机所有更新</span>  
- git fetch origin 分支名 &nbsp;&nbsp;<span style="color:purple;">取回远程主机某个分支的更新</span>
- git pull origin 远程分支名：本地分支名  <span style="color:purple;">取回远程主机某个分支的更新，再与本地的指定分支合并</span>&nbsp;&nbsp;&nbsp;&nbsp;  
